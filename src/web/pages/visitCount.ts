...
import {
  ...
  VISIT_COUNT_DESC_0,
  VISIT_COUNT_DESC_1,
  VISIT_COUNT_DESC_2, VISIT_COUNT_DISPLAYING,
  VISIT_COUNT_FAILED,
  VISIT_COUNT_LOADING,
  VISIT_COUNT_LOAD_MORE,
  VISIT_COUNT_LOAD_MORE_FAILED,
  VISIT_COUNT_LOAD_MORE_LOADING,
  VISIT_COUNT_TIMES,
  VISIT_COUNT_TIME_FRAME_ALL,
  VISIT_COUNT_TIME_FRAME_DAY,
  VISIT_COUNT_TIME_FRAME_HOUR,
  VISIT_COUNT_TIME_FRAME_MONTH,
  VISIT_COUNT_TIME_FRAME_WEEK,
  VISIT_COUNT_TIME_FRAME_YEAR,
  VISIT_COUNT_TITLE
} from '../constant/messages';
import { closeChapter } from '../control/chapterControl';
