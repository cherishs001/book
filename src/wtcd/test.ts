...
const sourceMin = `WTCD 1.0 declare [ number money = 100 number arousal = 0 number sensitivity = 10 number aphrodisiac = 0 boolean vibrator = false boolean vaginalDildo = false boolean analDildo = false boolean chastityBelt = false ] section initialShop then goto purchaseList section shop then goto purchaseList section purchaseList then selection [ choice "购买春药（20 元）" money >= 20 ? goto purchaseAphrodisiac : null vibrator ? null : choice "购买跳蛋（15 元）" money >= 15 ? goto purchaseVibrator : null vaginalDildo ? null : choice "购买阴道按摩棒（20 元）" money >= 20 ? goto purchaseVaginalDildo : null analDildo ? null : choice "购买肛门按摩棒（20 元）" money >= 20 ? goto purchaseAnalDildo : null chastityBelt ? null : choice "购买贞操带（50 元）" money >= 50 ? goto purchaseChastityBelt : null choice "离开商店" goto exitShop ] section purchaseAphrodisiac { money -= 10 aphrodisiac += 1 sensitivity += (aphrodisiac == 5) ? 50 /* 第五瓶春药是内服的。*/ : 10 } then goto shop section purchaseVibrator { money -= 15 vibrator = true } then goto shop section purchaseVaginalDildo { money -= 20 vaginalDildo = true } then goto shop section purchaseAnalDildo { money -= 20 analDildo = true } then goto shop section purchaseChastityBelt { money -= 50 chastityBelt = true } then goto shop section exitShop then ((!vibrator) && (!vaginalDildo) && (!analDildo)) ? (chastityBelt) ? goto beltedDry : goto dry : (chastityBelt) ? goto belted : goto unbelted
...
parse(source, new MarkdownIt({ html: true }), console);
